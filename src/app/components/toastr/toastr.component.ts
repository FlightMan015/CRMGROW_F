...
export class ToastrComponent extends Toast {
  ...
  TITLES = {
    ...
    video_lead_capture: 'video lead captured',
    video_interest_capture: 'video lead captured',
    pdf_lead_capture: 'pdf lead captured',
    pdf_interest_capture: 'pdf lead captured',
    image_lead_capture: 'image lead captured',
    image_interest_capture: 'image lead captured',
