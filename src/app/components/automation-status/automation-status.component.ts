...
export class AutomationStatusComponent implements OnInit, OnDestroy {
  ...
  ICONS = {
    ...
    update_follow_up: '../../assets/img/automations/follow_up_update.svg',
    note: '../../assets/img/automations/create_note.svg',
    email: '../../assets/img/automations/send_email.svg',
    text: '../../assets/img/automations/send_text.svg',
    ...
    send_text_image: '../../assets/img/automations/send_image_text.svg',
