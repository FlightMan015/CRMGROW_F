...
export class TeamService extends HttpService {
   ...
   */
  searchTeam(keyword: string, skip: number = 0): Observable<any> {
  ...
  // shareVideos(teamIds, videoIds): Observable<any> {
  //   return this.httpClient
  ...
  //     );
  // }
  // sharePdfs(teamIds, pdfIds): Observable<any> {
  //   return this.httpClient
  ...
  //     );
  // }
  // shareImages(teamIds, imageIds): Observable<any> {
  //   return this.httpClient
  ...
  shareFolder(teamIds, data): Observable<any> {
    return this.httpClient
