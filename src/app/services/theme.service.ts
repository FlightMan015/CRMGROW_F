...
export class ThemeService extends HttpService {
  ...
  public getStandarTemplates(offset: number, limit: number): Observable<any> {
    return this.httpClient
      .post(this.server + THEME.STANDARD_TEMPLATES, { offset, limit })
      .pipe(
        map((res) => res),
  ...
  public getTemplate(slug: string): Observable<any> {
    return this.httpClient
      .post(this.server + THEME.STANDARD_TEMPLATE, { slug })
      .pipe(
        map((res) => res),
